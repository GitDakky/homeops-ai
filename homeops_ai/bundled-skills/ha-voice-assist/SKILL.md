...
- When the add-on and Home Assistant are on the same host, prefer the native Hermes Agent integration with auto-discovery or local connection details instead of the ingress page URL.

# Legacy OpenClaw source-fork changelog

This file preserves inherited history from the source add-on fork before HomeOps AI became a Hermes Agent add-on. It is intentionally excluded from current user-facing release notes.
